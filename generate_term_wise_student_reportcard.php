...
<?php if(!empty($registration_number)){ ?><span class="text-center"><small>Registration Number : <?php echo $registration_number;?></small></span> <?php } ?>
</div>
<div class="col-md-6 text-right">
  <?php if(!empty($affiliation_number)){ ?><span class="text-right"><small>Affiliation No. / UDISE Code : <?php echo $affiliation_number;?></small></span> <?php } ?>
 </div>
</div>
...
<table class="table table-sm mt-2">
  <thead>
  <tr>
  <th class="text-center" width="40%" style="background:#ededed">Subjects</th>
  ...
  $PtestQ = mysqli_query($con,"select * from test where parent_test_id='$examid' and class_id='$clsid' AND  section_id='$secid' AND session='".$_SESSION['session']."'");
	...
	?>
	  <th class="text-center" style="background:#ededed"><h6><?=$TesName;?></h6>Max Marks: <?=$MaxMarks;?></th>  
	  ...
	  ?>
  <th class="text-center" style="background:#ededed"><h6>Total Marks:</h6><?=$Total_max_marks;?></th>   
  ...
  <tbody> 
	...
	<th scope="row"><?php echo $subject; ?></th>
		<?php		
			 ...
			 echo '<td class="text-center"><span style="background:'.$color.'" class="px-3 py-1">'.$marks.'</span></td>';   
	         }
	    ...
	    <td class="text-center"><span style="background:<?php echo $color ;?>;" class="px-3 py-1"><?php echo $total_Marks_by_test[$i][$scount]; ?></span></td>	
...
<!--end table-->  
	...
	<div class="col-md-6">
	<!-- <h6 class="text-center" style="color:#3214b3;"><?='0';?></h6> -->
	</div>
	</div>
...
<?php
  ...
  $TotalObtainMarks=$FinalMarks[$scount];
  $TotalMarks=$Total_max_marks*$No_Of_Subject;
  $Total_Percentile=round($TotalObtainMarks*100/$TotalMarks,2);
...
<div class="card border-0 p-0 bg-transparent co_scholastic">
<div class="card-title bg-success py-1" style="font-size:15px;color:white;border:1px solid black;border-top-left-radius:8px;border-top-right-radius:8px;">
<h6 class="ml-3">CO-SCHOLASTIC PERFORMANCE</h6>
</div>
<div class="card-body" style="margin-top:-25px; border-left:1px solid #000;border-right:1px solid #000;border-bottom:1px solid #000; border-bottom-left-radius:8px;border-bottom-right-radius:8px;">
...
<!--table-->
<table class="table border-0 table-sm mt-2">
  <tbody>
	  <thead>
	  <tr>
	...
	?> 
	  <tr>
      <th scope="row"><?php echo $rs['scholastic_name'];?></th>
      <td class="text-center"><span style="background:<?php echo $color;?>;" class="px-3 py-1"><?php echo $rs['grade'];?></span></td>
	  </tr>
    <?php
	}
	?>
...
<div class="row row-cols-1 row-cols-md-3 pb-4">
 ...
 <div class="col-md-4 mb-4 ">
	<div class="card h-100 rounded-0 bg-transparent d-flex justify-content-center align-items-center" style="border-bottom:1px solid #000;border-top:0;border-left:0;border-right:0;"></div>
  <p class="text-center">Controller of Examinations<br></p>
  </div>
<div class="col-md-4 mb-4 ">
	<div class="card h-100 rounded-0 bg-transparent d-flex justify-content-center align-items-center" style="border-bottom:1px solid #000;border-top:0;border-left:0;border-right:0;"></div>

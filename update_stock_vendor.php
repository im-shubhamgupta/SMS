 <?php
	...
	$sql=mysqli_query($con,"select * from stock_vendor where stock_vendor_id='$eid'");

	$res=mysqli_fetch_array($sql);

	$vendorname=$res['stock_vendor_name'];
...
<form action="" method="post">
	...
	<div class="card-footer">
		...
		<a href="dashboard.php?option=view_stock_vendor" class="btn btn-info btn-sm"> 
...
$('form').on('submit', function (e) {
	e.preventDefault();
  var action = "update_stock_vendor";
	...
	$.ajax({
		...
		success:function(responce) {
			...
			if(result.status=="success"){
				...
				window.location.href='dashboard.php?option=view_stock_vendor';
							// $('form')[0].reset(); 
				},3000);

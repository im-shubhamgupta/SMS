...
<form method="post" enctype="multipart/form-data" id="assign_driver">
...
<nav class="breadcrumb">
  ...
  <span class="breadcrumb-item active">Assign Driver & Vehicle to Route</span>
...
<!-- breadcrumb -->
  ...
  <div id="right-panel" class="right-panel" style="width:1000px">
	...
	<div class="row" style="margin-top:50px;margin-left:20px;">
		...
		<option value="<?php echo $rdr['id']; ?>"><?php echo $rdr['name']; ?>
		...
		<option value="<?php echo $rve['vehicle_id']; ?>"><?php echo $rve['vehicle_name']; ?>
	...
	<div class="row" style="margin-top:50px;margin-left:20px;">
		...
		<input style="margin-left:-100px;" type="text" class="form-control" id="vehicle_no" name="vehicle_no" readonly/>
		...
		<select style="width:170px;" class="form-select" name="route_id"  required>
		<!-- onchange="search_vehicleno(this.value);" -->
		...
		<option value="<?php echo $rrt['trans_id']; ?>"><?php echo $rrt['route_name']; ?>
	...
	<div class="row" style="margin-top:50px;margin-left:20px;">
		...
		<textarea style="margin-left:-100px;height:100px" class="form-control" name="description" placeholder="Enter Description" required></textarea>
...
$('form').on('submit', function (e) {
	e.preventDefault();
	// console.log(this);
  var action ="Assign_Driver_Route";

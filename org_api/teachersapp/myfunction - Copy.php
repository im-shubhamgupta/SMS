...
function gallery($classid,$sectionid,$message)
{
	global $con;
	...
	if($row)	
	{
		while($r1 = mysqli_fetch_array($q1))
		{
			...
			$q2=mysqli_query($con,"insert into student_notifications(category,student_id,class_id,section_id,selected_no,message,notice_datetime,date)
			values(4,'$studid','$classid','$sectionid','$mobile','$message',now(),now())");
		}
		return "Message Sent.";
	}
	else

...
function expensedetail($fromdt,$todt,$expid)
{
	global $con;
	$data = array();
	...
	if($expid=="0")
	{
		...
		while($r1 = mysqli_fetch_array($q1))
		{
			...
			$q2 = mysqli_query($con,"select * from expense where expense_type_id='$expenseid' and 
			date between '$chgfrdt' AND '$chgtodt'");
	...
	{
		$q2 = mysqli_query($con,"select * from expense where expense_type_id='$expid' and 
		date between '$chgfrdt' AND '$chgtodt'");

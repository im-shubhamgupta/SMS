...
if(isset($_POST['search']))
{
	...
	{
	$query = "SELECT * FROM `expense` where status='0'";
	$search_result = filterTable($query);	
	}	
...
<nav class="breadcrumb">
  ...
  <span class="breadcrumb-item active">Expense Report</span>
</nav>
<!-- breadcrumb -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="row" style="margin-top:20px;">
								...
								<!--<input  >-->
								<input type="text" id="fromdate" name="fromdt" value="<?php echo $fdt;?>" class="form-control" style="width:175px;" readonly="readonly">
								</div>
								<div class="col-md-1"></div>
								<div class="col-md-3" style="font-size:14px;">To Date</div>
								<div class="col-md-2" style="margin-left:-180px;margin-top:-10px">
								<input type="text" id="todate" name="todt" value="<?php echo $tdt;?>" class="form-control" style="width:175px;" readonly="readonly">
								</div>

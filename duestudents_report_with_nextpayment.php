...
if(isset($_POST['search']))
{
	...
	if($range==1)
	{
		...
		$query="select a.student_id, a.student_name, a.register_no, a.father_name, a.parent_no, a.class_id, a.section_id, a.due,
				...
				where (b.status='0' || b.status='1' || b.status='3') and a.class_id='$class' and section_id='$section' and a.due < '$r1'";
	...
	// {
		...
		// $query="select a.student_id, a.student_name, a.register_no, a.father_name, a.class_id, a.section_id, a.due,
				...
				// from students a
				// LEFT JOIN student_due_fees b ON a.student_id = b.student_id and a.due = b.due_amount
				// where a.class_id='$class' and section_id='$section' and a.due > '$r1'";
		// $search_result = filterTable($query);
		// }
	...
	// {
		...
		// $query="select a.student_id, a.student_name, a.register_no, a.father_name, a.class_id, a.section_id, a.due,
				...
				// from students a
				// LEFT JOIN student_due_fees b ON a.student_id = b.student_id and a.due = b.due_amount
				// where a.class_id='$class' and section_id='$section' and a.due between '$r1' and '$r2'";
		// $search_result = filterTable($query);
		// }
...
if(isset($sms))
{
	...
	if($status==0)
	{
	echo "<script>window.location='send_sms_duestudents.php?class=$class&section=$section&range=$range&r1=$r1&r2=$r2&nextpay=$nextpay'</script>";
	}
	else
	{
...
<!-- breadcrumb -->
   <form method="post" action="dashboard.php?option=duestudents_report" enctype="multipart/form-data">      
                ...
                <div class="row">
                    <div class="col-md-12">
						...
						<div class="row" style="margin-top:20px;">	
								...
								<div class="col-md-2" style="margin-top:-8px;">
								<input type="number" name="r2" class="form-control" value="<?php echo $r2;?>" id="range1" disabled>
								</div>
						...
						<div class="card">
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered table-responsive">
									...
									if($class!="")
									{
										$feestr1 = $r1['fee_header_id'];
										$feearr1 = explode(',',$feestr1);
										
										$feeamt = $r1['fee_header_amount'];
										$feeamtarr = explode(',',$feeamt);
										
										foreach($feearr1 as $k)
										{
		...
		<a href="print_duestudents.php?class=<?php echo $class;?>&section=<?php echo $section;?>&range=<?php echo $range;?>&r1=<?php echo $r1;?>&r2=<?php echo $r2;?>&nextpay=<?php echo $nextpay;?>" class="btn btn-primary btn-sm" style="margin-left:20px;"><i class="fa fa-print"></i> Print</a>
		
		<a href="export_duestudent_excel.php?class=<?php echo $class;?>&section=<?php echo $section;?>&range=<?php echo $range;?>&r1=<?php echo $r1;?>&r2=<?php echo $r2;?>&nextpay=<?php echo $nextpay;?>" class="btn btn-success btn-sm" style="margin-left:20px;"><i class="fa fa-download"></i> Download To Excel</a>

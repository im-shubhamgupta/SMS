...
if(isset($sms))
{
	...
	//$link = mysqli_connect("localhost", "root", "", "school_billing") or die("Error " . mysqli_error($link));
    ...
    $senderId = $value['senderId'];
		foreach($value['report'] as $key1 => $value1)
		{
			...
			$date = $value1['date'];
			$query = "INSERT INTO notifications (request_id,user_id,sender_id,date,receiver,status,description) VALUES ('" . $requestID . "','" . $userId . "','" . $senderId . "','" . $date . "','" . $receiver . "','" . $status . "','" . $desc . "')";

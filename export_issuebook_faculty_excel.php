...
$columnHeader ='';
$columnHeader = "Faculty Name".","."Faculty ID".","."Faculty No".","."Book Name".","."Book Author".","."Book ISBN".","."Publisher Name".","."Issued Date".","."Return Date";
...
$data .= $stname.",".$staffid.",".$mobno.",".$bkname.",".$author.",".$bkisbn.",".$pubname.",".$issuedt.",".$returndt."\n";
}
...
$filename =  "Issuedbook_detail".$dat.".csv";

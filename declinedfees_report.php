...

{
	...
	$query="select * from student_due_fees where class_id='$class' and section_id='$section' and status=2 and session ='".$_SESSION['session']."'";	
	...
	$query="select * from student_due_fees where class_id='$class' and status=2 and session ='".$_SESSION['session']."' ";					
	...
	$query="select * from student_due_fees where status=2 and session ='".$_SESSION['session']."'";					
...
<nav class="breadcrumb">
  ...
  <span class="breadcrumb-item active">Declined Fees Report</span>

</nav>

<!-- breadcrumb -->

   <form method="post" action="dashboard.php?option=declinedfees_report" enctype="multipart/form-data">      
            ...
            <div class="animated fadeIn">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
						...
						echo "<h5 style='border:1px solid grey;padding:10px;boder-radius:10px;'> The Total declined amount from $clsn , $sec &nbsp;Section is : Rs $gtotal. </h5>";

...
<nav class="breadcrumb">
  ...
  <span class="breadcrumb-item active">Category Chart</span>
        ...
        <div class="content mt-3" style="width:1000px;">
            ...
            <div class="animated fadeIn">
				...
				<div class="col-md-12">
					...
					<a href="print_category_report.php" target="_blank" class="btn btn-primary btn-sm"> <i class="fa fa-print"></i> Print</a>
				...
				<div class="col-md-12">	
					...
					<div class="row">
							...
							<div id="chartContainer2" style="height:400px; width:100%; margin-left:0px;"></div>
					...
					<div class="card-body">
						...
						<table id="bootstrap-data-table-export" class="table table-striped table-bordered table-responsive">
							...
							?>
								...
								// $qu = mysqli_query($con,"select * from students where class_id='$clid' && section_id='$secid' && gender='male' and session='".$_SESSION['session']."' ");
								...
								// $qu = mysqli_query($con,"select * from students where class_id='$clid' && section_id='$secid' && gender='female' and session='".$_SESSION['session']."' ");
					...
					<a href="print_gender_report.php"  target="_blank" 

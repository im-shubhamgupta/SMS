...
<nav class="breadcrumb">
  ...
  <a class="breadcrumb-item" href="dashboard.php?option=view_branch">View Branch</a>
...
<form action="" method="post">
	...
	<div class="card-body card-block">
			...
			<input type="text" name="branch" placeholder="Enter Branch" class="form-control" required></div>

...
if (isset($_REQUEST['sessionid']) && isset($_REQUEST['login_user_id']) && isset($_REQUEST['msgtype']) ) {
    ...
    $result = message_list($class_id, $section_id,$msgtype, $sessionid, $login_user_id, $current_page, $per_page);

...
$section_id=$_REQUEST['section_id'];
	...
	$result=fees_paid_students($session_id,$class_id,$section_id, $current_page, $per_page);
	...
	$response["message"] = "Required parameter missing session_id, class_id, section_id";

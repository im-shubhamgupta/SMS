...
if(isset($_REQUEST['class_id'])  && isset($_REQUEST['session_id']) && isset($_REQUEST['test_id']) ){
...
$per_page = isset($_REQUEST['per_page']) ? $_REQUEST['per_page'] : '';
	...
	$result=view_test_details($session_id,$class_id,$section_id,$test_id, $current_page,$per_page);
	...
	$response["message"] = "Required parameter missing session_id, class_id, test_id";

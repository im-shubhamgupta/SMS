...

{
    ...
    // search in all table columns
		...
		$query = "SELECT * FROM `issue_bookto_students` WHERE `branch_id`='$branch' and return_status='1' and issue_date between '$fromdt' AND '$todt'";
    ...
    // search in all table columns
		...
		$query = "SELECT * FROM `issue_bookto_students` WHERE `branch_id`='$branch' and book_id='$book' and return_status='1' and issue_date between '$fromdt' AND '$todt'";
...
<a class="breadcrumb-item" href="dashboard.php"><i class="fa fa-home"></i> Dashboard</a>
  ...
  <span class="breadcrumb-item active">Returned Book Detail</span>
	...
	<form method="post" action="dashboard.php?option=returnedbook_student_detail" enctype="multipart/form-data">
		...
		<a href="export_returnedbook_student_excel.php?branchid=<?php echo $branch;?>&bookid=<?php echo $book;?>&fromdt=<?php echo $fromdt;?>&todt=<?php echo $todt;?>" class="btn btn-success btn-sm" style="margin-left:20px;"> <i class="fa fa-download"></i> Download To Excel</a>

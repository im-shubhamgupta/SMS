...
<nav class="breadcrumb">
  ...
  <span class="breadcrumb-item active">View Submenu</span>
</nav>
<!-- breadcrumb -->
<div id="right-panel" class="right-panel">
        ...
        <div class="breadcrumbs">
            <div class="col-sm-4" style="padding:10px;">  
                     <a href="dashboard.php?option=add_submenu" class="btn btn-primary btn-sm">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
								...
								<!--		<?php
									...
									<?php 
									$sr=1;
									$query=mysqli_query($con,"select * from sub_menu");
									while($res=mysqli_fetch_array($query))
									{
									$id=$res['sub_menu_id'];
									$subname=$res['sub_menu_name'];
									$menuid=$res['menu_id'];
									...
									$re1=mysqli_query($con,"select * from menu where menu_id='$menuid'");

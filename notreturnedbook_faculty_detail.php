...
<a class="breadcrumb-item" href="dashboard.php"><i class="fa fa-home"></i> Dashboard</a>
  ...
  <span class="breadcrumb-item active">Returned Book Detail</span>
	...
	<form method="post" action="dashboard.php?option=notreturnedbook_faculty_detail" enctype="multipart/form-data">
		...
		<a href="export_notreturnedbook_faculty_excel.php?branchid=<?php echo $branch;?>&bookid=<?php echo $book;?>&fromdt=<?php echo $fromdt;?>&todt=<?php echo $todt;?>" class="btn btn-success btn-sm" style="margin-left:20px;"> <i class="fa fa-download"></i> Download To Excel</a>

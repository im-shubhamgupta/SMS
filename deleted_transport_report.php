...
<nav class="breadcrumb">
  ...
  <span class="breadcrumb-item active">Deleted Report</span>
...
<!-- breadcrumb -->
   ...
   <form method="post" action="dashboard.php?option=deleted_transport_report" enctype="multipart/form-data">      
                            ...
                            <div class="card-body">
                                ...
                                <table id="table-grid" class="table table-striped table-bordered">
									...
									<tr>
										...
										<td><?php echo "<a href='reprint_transdeleted_receipt.php?id=$logid' class='btn btn-outline-success btn-sm' target='_blank' title='Print Deleted Receipt'>Print</a>";?></td>
		...
		<a href="print_deletedfee.php?class=<?php echo $class;?>&section=<?php echo $section;?>" class="btn btn-primary btn-sm" style="margin-left:20px;"><i class="fa fa-print"></i> Print</a>

		

		<a href="export_deletedfee_excel.php?class=<?php echo $class;?>&section=<?php echo $section;?>" class="btn btn-success btn-sm" style="margin-left:20px;"><i class="fa fa-download"></i> Download To Excel</a>

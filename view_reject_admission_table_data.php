...
// }
 ...
 $sql = "SELECT * FROM `admission` where `status`='3' and session='".$_SESSION['session']."' ";
...
while($Row=mysqli_fetch_array($query) ) {  // preparing an array
	...
	$nestedData[] = get_class_byid($Row["grade"])['class_name'];	
	// $nestedData[] = $Row["phone"];

	$nestedData[] = $Row["previous_school"];
	
	// $nestedData[] = $Row["previous_school"];
	$nestedData[] = get_class_byid($Row["previous_grade"])['class_name'];

...
extract($_REQUEST);
	...
	$query="select * from events where 1 and session='".$_SESSION['session']."'";		
...

{
	...
	$query="select * from events where from_date>='$fromdt1' AND to_date<='$todt1' and session='".$_SESSION['session']."'";		
	...
	$query="select * from events where from_date>='$fromdt1' AND to_date<='$todt1' && event_for!='1' and session='".$_SESSION['session']."'";		
	...
	else if($eventfor=="1" && $class!="0" && $section!="0")

	{

	$query="select * from events where from_date>='$fromdt1' AND to_date<='$todt1' AND class_id='$nclass' AND (section_id='$nsection' || event_for='3') and session='".$_SESSION['session']."'";		
	...
	$query="select * from events where from_date>='$fromdt1' AND to_date<='$todt1' AND (event_for='1' || event_for='3') and session='".$_SESSION['session']."'";		
                ...
                <div class="row">
...

					{
...

						{
							...
							document.getElementById("search_sect").selectedIndex =0;
						...
						<div class="row" id="test" style="display:none">
							...
							<select name="class" id="classid" class="form-control" onchange="search_sec(this.value)" style="width:175px;">
                                ...
                                <table id="table-grid" class="table table-striped table-bordered">
                                    ...
                                    <thead>
                                        ...
                                        <tr>
											...
											<?php if($_SESSION['user_roles']=="admin" || $_SESSION['user_roles']=="superadmin"){?> 
...
var dataTable = $("#table-grid").DataTable({
	"lengthMenu": [ [10, 25, 50, 100, 500,99999999], [10, 25, 50, 100, 500,'All'] ],	
                    // 'order':[1,'DESC'],
                    dom: 'Blfrtip',

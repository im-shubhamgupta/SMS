...
<?php }?>
	...
	<div class="row" style="margin-top:-14px;margin-bottom:-27px;">				
		...
		<?php
					$qfee1 = mysqli_query($con,"select * from student_wise_fees where student_id='$stuid' and session='$session'");
	...
	<div class="col-md-5"><p style="align:left;font-size:18px;color:#1c1515"><?php echo $tbal+$monthly_fee_due+$Late_fee;?></p></div>
	</div>
	<hr>
  ...
  <div class="row">
	  <div class="col-md-12"><footer><b>Note: </b>Dues paid before 15 per month, after 15 it will be charge late fine.    </footer></div>
	</div>

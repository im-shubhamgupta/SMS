...

{
    ...
    // search in all table columns
		...
		$query = "SELECT * FROM `issue_bookto_faculty` WHERE `branch_id`='$branch' and issue_date between '$fromdt' AND '$todt'";
    ...
    // search in all table columns
		...
		$query = "SELECT * FROM `issue_bookto_faculty` WHERE `branch_id`='$branch' and book_id='$book' and issue_date between '$fromdt' AND '$todt'";
...
<a class="breadcrumb-item" href="dashboard.php"><i class="fa fa-home"></i> Dashboard</a>
  ...
  <span class="breadcrumb-item active">Issued Book Detail</span>
	...
	<form method="post" action="dashboard.php?option=issuedbook_faculty_detail" enctype="multipart/form-data">
		...
		<a href="export_issuebook_faculty_excel.php?branchid=<?php echo $branch;?>&bookid=<?php echo $book;?>&fromdt=<?php echo $fromdt;?>&todt=<?php echo $todt;?>" class="btn btn-success btn-sm" style="margin-left:20px;"> <i class="fa fa-download"></i> Download To Excel</a>

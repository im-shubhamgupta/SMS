...
<nav class="breadcrumb">
  ...
  <span class="breadcrumb-item active">Return Stock Report</span>
</nav>
<!-- breadcrumb -->
   <form method="post" action="dashboard.php?option=view_return_stock_report" enctype="multipart/form-data">      
                    ...
                    <div class="col-md-12">
						...
						<div class="card">
							...
							<div class="card-footer">
								<a href="export_returnstock_report_excel.php?fromdt=<?php echo $fromdt;?>&todt=<?php echo $todt;?>&sttypeid=<?php echo $sttypeid;?>&vendorid=<?php echo $vendor;?>" class="btn btn-success btn-sm">

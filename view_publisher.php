<script type="text/javascript">
	function delet(id)
	{
		...
		{
			window.location.href='delete_publisher.php?x='+id;
		}
	}
</script>
<form method="post">
...
<nav class="breadcrumb">
  ...
  <span class="breadcrumb-item active">View Publisher</span>
</nav>
<!-- breadcrumb -->
		<?php
        ...
        <div class="breadcrumbs">
            <div class="col-sm-4" style="padding:10px;">  
                     <a href="dashboard.php?option=add_publisher" class="btn btn-primary btn-sm">
					 <i class="fa fa-plus"></i> Add Publisher</a>
            </div>
        </div>
		<?php
		}
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
									...
									<tr>
										<td><?php echo $sr; ?></td>
										<td><?php echo $res['publisher_name']; ?></td>
										<td>
										<?php echo "<a href='dashboard.php?option=update_publisher&eid=$id' class='btn btn-secondary btn-sm'> <i class='fa fa-edit'></i> Edit</a>";
											?>

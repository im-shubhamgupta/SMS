...
$columnHeader = "Student Name".","."Class".","."Section".","."Register No".","."Father Name".","."Father No".","."Book Name".","."Book Author".","."Book ISBN".","."Publisher Name".","."Issued Date".","."Return Date";
...
$bkisbn.",".$pubname.",".$issuedt.",".$returndt."\n";

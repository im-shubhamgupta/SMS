            ...
            <div class="animated fadeIn">
                <div class="row">
                    ...
                    <div class="col-md-12">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered table-responsive">
									...
									<?php
									$dataPoints1 = array(
											array("label"=> "cat1", "y"=> 53),
											array("label"=> "cat2", "y"=> 18)
							...
							<div>
							<a href="export_categoryreport_excel.php" class="btn btn-success btn-sm" style="margin-left:380px">Download To Excel</a>
							</div>
							<br> 
					...
					<!---------------- Gender Report ---------------->		
							...
							<div>
							<a href="export_genderreport_excel.php" class="btn btn-success btn-sm" style="margin-left:380px">Download To Excel</a>
							</div>
							<br> 

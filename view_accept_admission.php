                    ...
                    <div class="col-md-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
								...
								<h4>View Accept Admission Details</h4>
...
$(document).ready(function(){
			...
			var dataTable = $("#table-grid").DataTable({
                    ...
                    "scrollX": true,
					"ajax":{
						'url' :"view_accept_admission_table_data.php", // json datasource
...
<!-- 
									...
									$query =mysqli_query($con,"SELECT * FROM admission WHERE status='2'");
									...
									$acceptdt=$res['accept_decline_date'];

									$newacceptdt=date("d-M-y",strtotime($acceptdt));

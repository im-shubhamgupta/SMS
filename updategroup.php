<?php
	...
	$query = mysqli_query($con,"select * from custome_group where group_id='$id'");

	$res = mysqli_fetch_array($query);

	$grpname = $res['group_name']; 
...
<nav class="breadcrumb">
  ...
  <span class="breadcrumb-item active">Update Group</span>
...
<form action="" method="post">
	...
	<div class="card-body card-block">
			...
			<input type="text" name="ngroup" value="<?php echo $grpname;?>" placeholder="Enter Group" 
	...
	<div class="card-footer">
		...
		<a href="dashboard.php?option=view_group" class="btn btn-info btn-sm"> 
	...
	$.ajax({
		...
		success:function(responce) {
			...
			if(result.status=="success"){
				...
				window.location.href='dashboard.php?option=view_group';
							// $('form')[0].reset(); 
				},3000);

...
if(isset($_POST['custom'])){
    ...
    $leave_status=$_POST['custom']['leave_status'];
    $student_id=$_POST['custom']['student_id'];
...
if(!empty($class_id) && empty($section_id)){
		$sql.=" and `sl`.`class_id` ='".$class_id."' ";
}elseif(!empty($class_id) && !empty($section_id)){
	$sql.=" and `sl`.`class_id` ='".$class_id."'  and `sl`.`section_id` ='".$section_id."' ";
} 

if(!empty($leave_status)){
	$sql.=" and `sl`.`status` = '$leave_status' ";
}
if(!empty($student_id)){

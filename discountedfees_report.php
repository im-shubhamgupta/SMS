...
<nav class="breadcrumb">
  ...
  <span class="breadcrumb-item active">Discounted Fees Report</span>
...
<!-- breadcrumb -->
   ...
   <form method="post" action="dashboard.php?option=discountedfees_report" enctype="multipart/form-data">      
		...
		<a href="print_discountedfee.php?class=<?php echo $class;?>&section=<?php echo $section;?>" target="_blank" class="btn btn-primary btn-sm" style="margin-left:20px;"><i class="fa fa-print"></i> Print</a>

<script type="text/javascript">
	function delet(id)
	{
		...
		{
			window.location.href='delete_vendor.php?x='+id;
		}
	}
</script>
<form method="post">
...
<!-- breadcrumb -->
        ...
        <div class="breadcrumbs">
            <div class="col-sm-4" style="padding:10px;">  
                     <a href="dashboard.php?option=add_vendor"  class="btn btn-primary btn-sm">
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
									...
									<tr>
										...
										<td>
										<?php echo "<a href='dashboard.php?option=update_vendor&eid=$id' class='btn btn-secondary btn-sm'> <i class='fa fa-edit'></i> Edit</a>";
											?>
